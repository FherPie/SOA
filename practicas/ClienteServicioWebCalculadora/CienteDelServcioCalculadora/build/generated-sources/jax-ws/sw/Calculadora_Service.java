 ...
 * 
 */
@WebServiceClient(name = "calculadora", targetNamespace = "http://calculadora.jtech/", wsdlLocation = "http://localhost:8080/Calculadora/calculadora?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULADORA_QNAME = new QName("http://calculadora.jtech/", "calculadora");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Calculadora/calculadora?wsdl");
    ...
    public Calculadora getCalculadoraPort() {
        return super.getPort(new QName("http://calculadora.jtech/", "CalculadoraPort"), Calculadora.class);
    }
    ...
    public Calculadora getCalculadoraPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calculadora.jtech/", "CalculadoraPort"), Calculadora.class, features);
    }
