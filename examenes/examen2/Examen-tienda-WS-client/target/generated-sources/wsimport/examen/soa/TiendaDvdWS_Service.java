 ...
 * 
 */
@WebServiceClient(name = "TiendaDvdWS", targetNamespace = "http://soa.examen/", wsdlLocation = "http://localhost:8080/Examen-tienda-WS/TiendaDvdWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TIENDADVDWS_QNAME = new QName("http://soa.examen/", "TiendaDvdWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Examen-tienda-WS/TiendaDvdWS?wsdl");
    ...
    public TiendaDvdWS getTiendaDvdWSPort() {
        return super.getPort(new QName("http://soa.examen/", "TiendaDvdWSPort"), TiendaDvdWS.class);
    }
    ...
    public TiendaDvdWS getTiendaDvdWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soa.examen/", "TiendaDvdWSPort"), TiendaDvdWS.class, features);
    }
